...
def get_memory_service():
    ...
    if agent_engine_id := os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID") or os.environ.get("MEMORY_BANK_ID", "4937018314946772992"):
        from google.adk.memory import VertexAiMemoryBankService

        return VertexAiMemoryBankService(
            project=os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-04-2a75196ccefd"),
            location=os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_LOCATION")
